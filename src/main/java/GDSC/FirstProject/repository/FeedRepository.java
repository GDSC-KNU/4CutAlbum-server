...
public interface FeedRepository extends JpaRepository<Feed, Long> {
    ...
    @Query(
            " select new GDSC.FirstProject.dto.dbDto.feedListDbDto(f.id, f.s3Key, f.peopleCount, c.value, h.value)" +
                    " from Feed f" +
    ...
    Optional<List<feedListDbDto>> findFeedList(@Param("company_name") String company_name, @Param("people_count") Long people_count, @Param("hashtags") String[] hashtags);
}